...
#include <SPI.h>        //Not sure I need this, but just in case. Tobrien 20260119
...
byte mac[] = {
  //0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xED  // Hilarious Dead Beef Feed
  0x90, 0xA2, 0xDA, 0x0D, 0x0F, 0xDB
};
